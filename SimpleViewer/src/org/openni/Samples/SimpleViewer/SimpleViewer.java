...
public class SimpleViewer extends Component 
    ...
    //float mHistogram[];
	ArrayList<Float> mHistogram = new ArrayList<>();
    int[] mImagePixels;
        ...
        switch (mLastFrame.getVideoMode().getPixelFormat())
        {
            ...
            case SHIFT_9_3:
                ...
                while(frameData.remaining() > 0) {
                    ...
                    short pixel = (short)mHistogram.get(depth).shortValue();
    ...
    private void calcHist(ByteBuffer depthBuffer) {
        ...
        while (depthBuffer.remaining() > 0) {
            ...
            if (depth != 0) {
            	...
            	mHistogram.set(depth, mHistogram.get(depth)+1);
                //mHistogram[depth]++;
                points++;
            }
        }
        ...
        //System.out.println(mHistogram.size());
    }
}
